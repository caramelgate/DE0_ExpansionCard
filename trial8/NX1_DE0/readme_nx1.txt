...
対応メモリはSDR-SDRAN(MIG互換)、cellula ram(MIG互換)、DDR-SDRAM(ザイリンクス MIG使用)です。
...
AVNET MicroBoard(Spartan6LX)は対応予定です。
DIGILENT Nexys3(Spartan6LX)は対応予定です。
...
X1TURBOの漢字TEXTはMIGのレイテンシーが長いので対応しません。
